...
export function DashboardContent() {
  ...
  const gpaLabel = uploadedAudit.gpa !== null ? uploadedAudit.gpa.toFixed(2) : "N/A"
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">UF GPA</p>
                <p className="text-xl font-semibold">{gpaLabel}</p>
              </div>
            </div>
          </CardContent>
        </Card>
